...
public class ThreadDemo3 {
    public static void main(String[] args) {
        // 掌握多线程的创建方式三：实现Callable接口，方式三的优势：可以获取线程执行完毕后的结果的。
        ...
        // 5.把FFutureTask对象作为参数传递给Thread线程对象
        ...
        // 获取线程的结果
        try {
            // 如果发现第一个线程还没有执行完毕，会让出CPU，等第一个线程执行完毕后，才会往下执行
        ...
        try {
            // 如果发现第二个线程还没有执行完毕，会让出CPU，等第二个线程执行完毕后，才会往下执行
