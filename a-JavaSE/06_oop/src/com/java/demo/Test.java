...
public class Test {
    public static void main(String[] args) {
        ...
        // 4、办一张金卡：创建金卡对象，交给一个独立的业务（支付机）来完成存款和消费：存款，消费。
        GoldCard goldCard = new GoldCard("京E88777", "liu", "158***8025", 5000);
        goldCard.deposit(100);
        pay(goldCard);
        // 4、办一张银卡：创建银卡对象，交给一个独立的业务（支付机）来完成存款和消费：存款，消费。
        SilverCard silverCard = new SilverCard("京A77777", "liu", "158***8025", 2000);
        pay(silverCard);
    }
