...
public class ThreadTest {
    public static void main(String[] args) {
        ...
        // 现在公司举办了年会活动，活动中有一个红包雨环节，要求是共计发出200个红包雨，其中小红包再[1 - 30]元之间，
